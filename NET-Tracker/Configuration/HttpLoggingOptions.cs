...
namespace NET_Tracker.Configuration
{
    ...
    public class HttpLoggingOptions
    {
        ...
        /// <summary>
        /// If true, request and response bodies will only be saved when an error occurs (StatusCode >= 400 or exception).
        /// Excellent for saving database space while still capturing debug data when needed.
        /// </summary>
        public bool LogBodyOnlyOnErrors { get; set; } = false;
    ...
    public class RetentionOptions
    {
        ...
        /// <summary>
        /// Maximum number of rows to keep in the database to prevent space exhaustion (e.g. for 1GB limit).
        /// If the total row count exceeds this, the oldest records will be deleted regardless of DaysToKeep.
        /// Set to 0 to disable.
        /// </summary>
        public int MaxRowsToKeep { get; set; } = 0;
