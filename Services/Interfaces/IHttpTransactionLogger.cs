...
namespace NET_Tracker.Services.Interfaces
{
    ...
    public interface IHttpTransactionLogger
    {
        ...
        Task LogTransactionAsync(Models.HttpTransaction transaction);
        ...
        Task<Models.HttpTransaction> GetTransactionAsync(string requestId);
        ...
        Task<List<Models.HttpTransaction>> SearchAsync(HttpTransactionFilter filter);
